...
if __name__ == "__main__":
    ...
    for _ in range(1):
        ...
        if key_name_dump in amass_occlusion:
            ...
            ) and "idxes" in amass_occlusion[key_name_dump]:
                bound = amass_occlusion[key_name_dump]["idxes"][
                    0
        ...
        pose_aa = np.concatenate(
            [entry_data["poses"][::skip, :66], np.zeros((root_trans.shape[0], 6))],
            axis=-1,
        )
    ...
    if upright_start:
        joblib.dump(
            ...
            "./amass/amass_single_example_upright.pkl",
            compress=True,
        )
    else:
        joblib.dump(
            amass_full_motion_dict,
            "./amass/amass_single_example.pkl",
            compress=True,
        )
